...
import ThemesbergLogo from "../logo.svg";
        ...
        <SimpleBar className={`collapse ${showClass} sidebar d-md-block bg-primary text-white`}>
          <div className="sidebar-inner px-4 pt-3">
            ...
            <Nav className="flex-column pt-3 pt-md-0">
              <NavItem title="Crear Trabajador" icon={faBook} link='/crearTrabajador' />
              <NavItem title="Lista Trabajadores" icon={faTable} link='/trabajadores'/>
              <NavItem title="Crear Tipo de Contrato" icon={faTable} link='/crearContrato'/>
            </Nav>
          </div>
        </SimpleBar>
      </CSSTransition>
